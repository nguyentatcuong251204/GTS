from goi_phu_danielevski import *        # Gói dùng để giải đa thức đặc trưng
import numpy as np
...
if __name__ == '__main__':
    A = np.loadtxt("input.txt", dtype=float)  # DOC MA TRAN TU FILE input.txt
