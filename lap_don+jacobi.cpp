...
#include "matrix.h" 
#define SumNorm 3
#define Vao "input_lap.txt"
#define Ra "output_lap.txt"
...
template<typename T>
matrix<T> jacobiloop(matrix<T> A, matrix<T> B, matrix<T> &X0, double &eps) // lap jacobi
{
    Check(A, B, X0, eps);
    double q;
    int type;
